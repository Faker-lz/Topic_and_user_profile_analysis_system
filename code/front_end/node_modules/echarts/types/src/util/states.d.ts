...
import { SeriesDataType, DisplayState, ECElement, BlurScope, InnerFocus, Payload, HighlightPayload, DownplayPayload, ComponentMainType } from './types';
...
export declare function handleGlboalMouseOutForHighDown(dispatcher: Element, e: ElementEvent, api: ExtensionAPI): void;
